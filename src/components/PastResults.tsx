                ...
                <div className="flex items-center gap-1 mt-1">
                  {numbers.map((num, i) => (
                    <span 
                      ...
                      className="w-8 h-8 rounded-full flex items-center justify-center text-sm font-semibold shadow-sm bg-white text-black border border-gray-300"
                    >
                      {num}
                    </span>
                  ))}
                  <span 
                    ...
                    className="w-8 h-8 rounded-full flex items-center justify-center text-sm font-semibold shadow-sm bg-yellow-400 text-black border border-yellow-500"
                  >
                    {specialBall}
                  </span>
                </div>
